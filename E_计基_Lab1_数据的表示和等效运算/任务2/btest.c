...
{
    int (*f2)(int,int) = (int (*)(int,int))f;
    int (*f2t)(int,int) = (int (*)(int,int))ft;
...
{
    int (*f3)(int,int,int) = (int (*)(int,int,int))f;
    int (*f3t)(int,int,int) = (int (*)(int,int,int))ft;
